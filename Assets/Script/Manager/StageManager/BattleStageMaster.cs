...
public partial class BattleStageMaster : MonoBehaviour
{
    ...
    public void LoadStageData(BattleStageUnitData battleStageUnitData)
    {
        stageType = battleStageUnitData.stageType;
        stageLevel = battleStageUnitData.stageLevel;
        playerUnitList = battleStageUnitData.playerUnitList;
        enemyUnitList = battleStageUnitData.enemyUnitList;
        stageClearCondition = battleStageUnitData.stageClearCondition;
        targetEnemyId = battleStageUnitData.targetEnemyId;
        surviveTurnCount = battleStageUnitData.surviveTurnCount;
    }
