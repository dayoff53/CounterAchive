...
class Pool
{
    ...
    // 풀링된 오브젝트들의 부모 트랜스폼을 관리하기 위한 부모 Transform
    Transform _root;
    Transform Root
    {
        get
    ...
    {
        _prefab = prefab;
        // 객체 생성, 획득, 반환, 삭제 시 호출될 콜백을 설정하여 ObjectPool을 생성
...
public class PoolManager : Singleton<PoolManager>
{
    ...
    /// </summary>
    /// <param name="go">비활성 GameObject</param>
